...
dir.create(paste(cov, "_aqualeap_logical_merged_",PP,"_results", sep=""), showWarnings = FALSE)
...
for(i in ids)
{
  ...
  imputed <- bind_rows(svtyper_based,glimpse_based,filt_anti)
  ...
  write_tsv(SVCon, paste(cov, "_aqualeap_logical_merged_",PP,"_results/",i, "_SV_logical_merged_results.txt", sep=""))
