...
cov<-"4x"
dir.create(paste(cov, "_aqualeap_svtyper_results", sep=""), showWarnings = FALSE)
...
for(i in ids)
{
  ...
  write_tsv(SVCon, paste(cov, "_aqualeap_svtyper_results/", i, "_svtyper_SVCon.txt", sep=""))
  write_tsv(SNPCon, paste(cov, "_aqualeap_svtyper_results/", i, "_svtyper_SNPCon.txt", sep=""))
}
