##use this script to extract the coverage values per chromosome across all the 10 samples
...
chr=("ssa01" "ssa02" "ssa03" "ssa04" "ssa05" "ssa06" "ssa07" "ssa08" "ssa09" "ssa10" "ssa11" "ssa12" "ssa13" "ssa14" "ssa15" "ssa16" "ssa17" "ssa18" \
"ssa19" "ssa20" "ssa21" "ssa22" "ssa23" "ssa24" "ssa25" "ssa26" "ssa27" "ssa28" "ssa29")

for (( a = 0; a < 20; a++ ))
do
	echo ${samples[$a]}
	cat ${samples[$a]}.*.cov | cut -f 7 | grep [0-9] >${samples[$a]}.coverage_values
done
