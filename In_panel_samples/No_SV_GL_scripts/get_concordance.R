...
cov<-"1x"
dir.create(paste(cov, "_inpanel_nosvtyper_results", sep=""), showWarnings = FALSE)
...
for(i in ids)
{
  ...
  write_tsv(SVCon, paste(cov, "_inpanel_nosvtyper_results/",i, "_inpanel_nosvtyper_SVCon.txt", sep=""))
  write_tsv(SNPCon, paste(cov, "_inpanel_nosvtyper_results/",i, "_inpanel_nosvtyper_SNPCon.txt", sep=""))
}
