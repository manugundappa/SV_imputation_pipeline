### calculate concordance for SVs only
...
dir.create(paste(cov, "_inpanel_svtyper_",PP,"_results", sep=""), showWarnings = FALSE)

##loop for SV concordance
for(i in ids)
{
  ...
  write_tsv(SNPCon, paste(cov, "_inpanel_svtyper_",PP,"_results/",i, "_inpanel_svtyper_",PP,"_SNPCon.txt", sep=""))
  write_tsv(SNPCon, paste(cov, "_inpanel_svtyper_",PP,"_results/",i, "_inpanel_svtyper_",PP,"_SVCon.txt", sep=""))
